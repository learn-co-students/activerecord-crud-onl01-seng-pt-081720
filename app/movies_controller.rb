...
def can_be_found_updated_and_saved
  ...
  show = Movie.find_by(title: "Awesome Flick")
  show.update(title: "Even Awesomer Flick")
  show.save
...
def can_update_using_update_method
  ...
  show = Movie.find_by(title: "Wat?")
  show.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  show = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  show.destroy
end
