...
def can_update_using_update_method
  ...
  created_movie = Movie.create(title: "Wat?")
  created_movie.update(title: "Wat, huh?")
end

def can_update_multiple_items_at_once
  # Change title of all movies to "A Movie"
  5.times do |i|
    created_movie = Movie.create(title: "Movie_#{i}", release_date: 2000+i)
    created_movie.update(title: "A Movie")
  end
end

def can_destroy_a_single_item
  created_movie = Movie.create(title: "That One Where the Guy Kicks Another Guy Once")
  created_movie.destroy
end
